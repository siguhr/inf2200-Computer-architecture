...
void mrg3(int i, int j, int n1, int n2, int arr[], int L[], int R[], int k){
...
void mrg2(int n1, int n2, int L[], int R[], int arr[], int l)
{
    asm_function();
    // int i = 0; 
    // int j = 0; 
